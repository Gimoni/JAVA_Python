...
<nav class="navbar navbar-expand-lg navbar-dark bg-dark">
  <div class="container">
    ...
    <u class="navbar-nav row">
      ...
      <li class="nav-item col-md-3" >
        <a class="nav-link" href="/language/page/1/10">Language_page</a>
      </li>
      <li class="nav-item col-md-3">
        ...
        <section class="py-5">
            <div class="container my-5">
                <div class="row justify-content-center">
                    <div class="col-lg-6">
                        <h2>SOUND CLOUD CONTEST</h2>
                        <p class="lead">Join our own project contest!! </p>
                        <p class="mb-0">SoundCloud is a German music streaming service that enables its users to upload, promote, and share audio. Founded in 2007 by Alexander Ljung and Eric Wahlforss, SoundCloud is one of the largest music streaming services in the world and is available in 190 countries and territories.</p>
                        		</div>
                    </div>
					<div class="row justify-content-center">
					<div class="col-lg-6">
...
<!--         <div class="py-5 bg-image-full" style="background-image: url('https://source.unsplash.com/4ulffa6qoKA/1200x800')"> -->
        <div class="py-5 bg-image-full" style="background-image: url('/img/mixer.jpg')">
            ...
            <div class="container my-5">
                <div class="row justify-content-center">
                    <div class="col-lg-6">
						...
						<p class="lead">A music festival is a community event with performances of singing and instrument playing that is often presented with a theme such as musical genre (e.g., rock, blues, folk, jazz, classical music), nationality, locality of musicians, or holiday. Music festivals are generally organized by individuals or organizations within networks of music production, typically music scenes, the music industries, or institutions of music education.</p>
