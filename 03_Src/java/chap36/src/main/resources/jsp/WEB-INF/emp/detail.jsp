...
<section class="container">
	...
	<menu class="btn-group">
		<a href="/emp/create" class="btn btn-dark">create</a>
		<a href="/emp/update?empno=${emp.empno}" class="btn btn-secondary">update</a>
		<a href="/emp/delete?empno=${emp.empno}" class="btn btn-dark">delete</a>
	</menu>
	</sec:authorize>
	<hr>
<!-- 	<ul> -->
