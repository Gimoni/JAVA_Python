...
public class AlphaExample6 {
	...
	public static void main(String[] args) throws InterruptedException {
		...
		boolean[][][] rect = new boolean[4][20][40]; // false로 초기화됨 _ 화면에 출력이 되면 true.
		...
		for (;;) {
			...
			if(rect[3-1][line-1][column-1] == false) {
				rect[3-1][line-1][column-1] = true;
				count++;
